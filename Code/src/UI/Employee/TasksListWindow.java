...
public class   TasksListWindow extends UserWindow{
	...
	public TasksListWindow(User user) {
		...
		taskLabel[4] = createLabel("شرح وظیفه:    این وظیفه به معنی انجام وظیفه یک است.", 340, 225+60*0);
		taskLabel[5] = createLabel("شرح وظیفه:    این وظیفه به معنی انجام وظیفه دو است.", 340, 225+60*1);
		taskLabel[6] = createLabel("شرح وظیفه:    این وظیفه به معنی انجام وظیفه سه است.", 340, 225+60*2);
		taskLabel[7] = createLabel("شرح وظیفه:    این وظیفه به معنی انجام وظیفه چهار است.", 340, 225+60*3);
	...
	return checkBoxes;
	 ...
	 @Override
	    public void paint(Graphics g){
	     ...
	     //   Stroke simple = new BasicStroke(1, BasicStroke.JOIN_ROUND, BasicStroke.JOIN_ROUND, 0, new float[]{5},0);
