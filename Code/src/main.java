...
//		new ProjectRequiermentsWindow(null);
	...
	//	new AddProjectResourcesWindow(null);
		...
		new EditResourceWindow(null,null);
...
//	JPanel radioPanel = new JPanel();
//  	add(radioPanel); 	
//      JRadioButton married = new JRadioButton("„ «Â·");
//      JRadioButton single = new JRadioButton("„Ã—œ");
//   //   radioPanel.setLayout(null);
//      ButtonGroup bG = new ButtonGroup();
//      bG.add(married);
//      bG.add(single);
//      radioPanel.setLocation(300,300);
