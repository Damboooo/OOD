...
//		new ProjectManagementMainWindow(Main.dbManager.getUser(1),Main.dbManager.getProject(1));
//		new ProjectDetailsWindow(Main.dbManager.getUser(1),Main.dbManager.getProject(1));
